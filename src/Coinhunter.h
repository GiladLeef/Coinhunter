...
public:
	...
	Coinhunter(const std::string& inputFile, int compMode, int searchMode, int coinType, bool useGpu, 
	...
	Coinhunter(const std::vector<unsigned char>& hashORxpoint, int compMode, int searchMode, int coinType, 
